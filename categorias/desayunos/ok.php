        ...
        ?>
                                ...
                                <div class = "titleRecipe"><a href="../../index.html">Inicio <span>></span></a>ok</div>
                                <div class = "introductionRecipe">d
                                </div>
                                <div class="imgContenedor">
                                    <div class="imageRecipe" style="--i:url(img/entrada1.jpg)"></div>
                                    <div class="commentRecipe">
                                        <div class = "foodPortions"><i class="fa-regular fa-user"></i> Rinde 9</div>
