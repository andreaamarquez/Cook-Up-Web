...
<html>
    ...
    <body>
        ...
        <div class = "titlePageAd"><a href="javascript:window.history.back()">Configuración<span>></span></a>Editar receta <span> ></span></div>
        <section class="todo">
        <?php
            $cad = new CAD();
                ...
                foreach($datos as $registro)
                {
                    ...
                    echo '
                        <div class="container3">
                            ...
                            <img src="../img/editar.png" alt="Icono Editar" style="height: 30px; margin-right: 30px" onclick="window.location.href = \'edicion.php?idReceta='.$idReceta.'\'">
                        </div>';
                }
            }
        ?>
